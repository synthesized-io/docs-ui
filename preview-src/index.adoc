...
* xref:#tabset1_tab-e[]
** xref:#tabset3_tab-i[]
*** xref:#tabset4_tab-alpha[]
*** xref:#tabset4_tab-beta[]
** xref:#tabset3_tab-ii[]
...
[openblock]
------
This demonstrates that nested tabsets work.
------
...
--------
[discrete]
== A discreet third level of nesting.
...
--------
[discrete]
== Another valorous third level of nesting.
